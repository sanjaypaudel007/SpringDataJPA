...
public interface ModelJpaRepository extends JpaRepository<Model, Long> {
	...
	//List<Model> findByPriceGreaterThanEqualAndPriceLessThanEqualAndWoodTypeContaining(BigDecimal lowest, BigDecimal highest, String wood);
	
	@Query("select m from Model m where m.price >= :lowest and m.price <= :highest and m.woodType like :wood")
	List<Model> findModelsByPriceRangeAndWoodType(@Param("lowest") BigDecimal lowest,
